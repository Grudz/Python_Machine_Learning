...
naive_forecast = series[split_time - 1:-1] # Fails without -1
...
plt.figure(figsize=(10, 6))
plot_series(time_valid, x_valid, start=0, end=150) # copies graph for 150 units
plot_series(time_valid, naive_forecast, start=1, end=150) # Shifts x by one
