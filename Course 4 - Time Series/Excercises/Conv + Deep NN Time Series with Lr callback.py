...
with open('/tmp/daily-min-temperatures.csv') as csvfile:
  ...
  for row in reader:
    ...
    time_step.append(step) # Ignore dates column
    step = step + 1
...
def windowed_dataset(series, window_size, batch_size, shuffle_buffer): # This functionand the one below organize/format the data. There is a sticky note marking this page
